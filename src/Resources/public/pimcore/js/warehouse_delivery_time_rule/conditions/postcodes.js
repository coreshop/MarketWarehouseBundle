...
pimcore.registerNS('coreshop.market_warehouse.warehouse_delivery_time_rule.conditions.postcodes');

coreshop.market_warehouse.warehouse_delivery_time_rule.conditions.postcodes = Class.create(coreshop.rules.conditions.abstract, {
    type: 'postcodes',
