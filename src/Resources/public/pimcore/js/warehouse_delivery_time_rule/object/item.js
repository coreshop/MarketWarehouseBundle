...
pimcore.registerNS('coreshop.market_warehouse.warehouse_delivery_time_rule.object');
pimcore.registerNS('coreshop.market_warehouse.warehouse_delivery_time_rule.object.item');
coreshop.market_warehouse.warehouse_delivery_time_rule.object.item = Class.create(coreshop.rules.item, {

    iconCls: 'coreshop_icon_warehouse_delivery_time_rule',
    ...
    getActionContainerClass: function () {
        return coreshop.market_warehouse.warehouse_delivery_time_rule.action;
    },

    getConditionContainerClass: function () {
        return coreshop.market_warehouse.warehouse_delivery_time_rule.condition;
    },
