...
pimcore.registerNS('pimcore.object.tags.coreShopMarketWarehouseWarehouseDeliveryTimeRule');
pimcore.object.tags.coreShopMarketWarehouseWarehouseDeliveryTimeRule = Class.create(pimcore.object.tags.abstract, {
                ...
                tools: [
                    {
                        ...
                        tooltip: t('add'),
                        handler: function () {
                            this.panels.push(new coreshop.market_warehouse.warehouse_delivery_time_rule.object.item(this, {}, -1, 'deliveryTimeRules'));
                        }.bind(this)
                    }
                ]
            });
    ...
    createItemPanel: function (data, id) {
        var panelItem = new coreshop.market_warehouse.warehouse_delivery_time_rule.object.item(this, data, id, 'deliveryTimeRules');
