...
pimcore.registerNS('pimcore.object.tags.coreShopMarketWarehouseSupplierShippingRule');
pimcore.object.tags.coreShopMarketWarehouseSupplierShippingRule = Class.create(pimcore.object.tags.abstract, {

    type: 'coreShopMarketWarehouseSupplierShippingRule',
    panels: [],
                ...
                tools: [
                    {
                        ...
                        tooltip: t('add'),
                        handler: function () {
                            this.panels.push(new coreshop.market_warehouse.supplier_shipping_rule.object.item(this, {}, -1, 'deliveryTimeRules'));
                        }.bind(this)
                    }
                ]
            });
    ...
    createItemPanel: function (data, id) {
        var panelItem = new coreshop.market_warehouse.supplier_shipping_rule.object.item(this, data, id, 'deliveryTimeRules');
